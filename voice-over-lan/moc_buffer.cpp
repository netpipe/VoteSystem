...
QT_MOC_LITERAL(4, 20, 5) // "input"

    },
    "Buffer\0output\0\0data\0input"
};
...
void Buffer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->input((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Buffer::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Buffer::output)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Buffer::output(QByteArray _t1)
{
